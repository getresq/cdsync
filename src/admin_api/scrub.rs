...
pub(super) fn scrub_postgres_config(pg: &PostgresConfig) -> ScrubbedPostgresConfig {
    ScrubbedPostgresConfig {
        ...
        cdc_batch_load_staging_worker_count: pg.cdc_batch_load_staging_worker_count,
        cdc_batch_load_reducer_worker_count: pg.cdc_batch_load_reducer_worker_count,
        cdc_max_inflight_commits: pg.cdc_max_inflight_commits,
        cdc_batch_load_reducer_max_jobs: pg.cdc_batch_load_reducer_max_jobs,
        cdc_batch_load_reducer_max_fill_ms: pg.cdc_batch_load_reducer_max_fill_ms,
        cdc_batch_load_reducer_enabled: pg.cdc_batch_load_reducer_enabled,
        cdc_ack_boundary: pg.cdc_ack_boundary,
        cdc_backlog_max_pending_fragments: pg.cdc_backlog_max_pending_fragments,
        cdc_backlog_max_oldest_pending_seconds: pg.cdc_backlog_max_oldest_pending_seconds,
